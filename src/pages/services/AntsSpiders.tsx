...
const FAMILIAR_ITEMS = [
  ...
  { emoji: "🐜", icon: "/images/sf-ant-trail.png",  text: "Every morning there's another trail of ants in my kitchen." },
  { emoji: "🕷", icon: "/images/sf-spider.png",     text: "Why am I suddenly seeing spiders in every room?" },
  { emoji: "😟", icon: "/images/sf-spray.png",      text: "I keep seeing them, even after using store sprays." },
  { emoji: "🤔", icon: "/images/sf-hidden.png",     text: "The few I see make me think there's a much bigger problem I can't see." },
  { emoji: "🏡", icon: "/images/sf-relief.png",     text: "I just want to stop worrying every time I see one." },
];

const HAPPENING_CARDS = [
  {
    tag: "The Ant Problem",
    title: "The ants you see are only the beginning.",
    body: "Seeing one or two ants usually means they're searching for food and marking a trail back to their colony. By the time ants appear in your kitchen or bathroom, hundreds more may already be nearby. Effective ant control means finding the source, not just treating the ants you can see.",
  ...
  {
    tag: "The DIY Problem",
    title: "DIY sprays solve today's sighting, not tomorrow's problem.",
    body: "Store-bought sprays may kill the pests you find today, but they rarely eliminate hidden colonies, nesting areas, or entry points. Professional pest control focuses on the source of the infestation, helping prevent ants and spiders from returning.",
...
const ATTRACT_REASONS = [
  {
    num: "01",
    label: "Food Sources",
    title: "Even the smallest crumb is an invitation.",
    body: "Sugar, crumbs, grease, pet food, and even tiny food residue are enough for scout ants to find. Once they do, they'll lead the rest of the colony straight to the source.",
  },
  {
    num: "02",
    label: "Moisture",
    title: "A little moisture goes a long way.",
    body: "Leaky pipes, damp soil, condensation, and standing water create the ideal environment for ants to survive, nest, and keep returning.",
  },
  {
    num: "03",
    label: "Hidden Nesting Areas",
    title: "They prefer the places you never look.",
    body: "Foundation cracks, wall voids, mulch beds, tree stumps, and landscaping provide safe nesting spots just outside or even inside your home.",
  },
  {
    num: "04",
    label: "Seasonal Changes",
    title: "The weather often sends them indoors.",
    body: "Heavy rain, extreme heat, and cooler temperatures push ants inside as they search for food, water, and shelter throughout the year.",
  },
  {
    num: "05",
    label: "Entry Points",
    title: "Tiny openings become busy highways.",
    body: "Small gaps around doors, windows, utility lines, siding, and foundations make it easy for ants to enter your home, often without you ever noticing.",
  },
];
...
const PROTECT_STEPS = [
  {
    method: "UNDERSTAND",
    num: "01",
    title: "Every pest leaves clues.",
    body: "We inspect entry points, nesting areas, moisture, and food sources to understand why ants and spiders chose your home.",
  },
  {
    method: "SOLVE",
    num: "02",
    title: "We focus on the source.",
...
const TIPS = [
  { title: "Seal Entry Points", body: "Close gaps around doors, windows, utility lines, and foundations to reduce easy access for ants." },
  { title: "Eliminate Food Sources", body: "Store food in sealed containers, wipe up crumbs, and clean pet feeding areas to remove what attracts scout ants." },
  { title: "Reduce Moisture", body: "Fix leaking pipes, improve drainage, and eliminate damp areas where ants are likely to nest." },
  { title: "Maintain Your Landscape", body: "Keep mulch, firewood, shrubs, and tree branches away from your home's foundation to reduce nesting opportunities." },
  { title: "Stay Ahead of Seasonal Activity", body: "Spring and summer are peak ant seasons. Preventative pest control treatments help stop colonies before they become infestations." },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Most treatments are completed in a single visit. The time varies based on the size of your property and the extent of the infestation. Your technician will give you a clear estimate when they arrive.",
  },
  {
  ...
  },
  {
    ...
    a: "Over-the-counter sprays kill what you see but rarely reach the colony. Professional treatment targets the source of the problem, not just the visible symptom.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Ants and spiders are treated as part of the same general pest service. Because spiders follow their food supply, treating both in one visit addresses the full picture rather than just one piece of it.",
  },
];
...
export default function AntsSpiders() {
  ...
  return (
    <>
      ...
      {/* 1. Hero */}
      <Hero
        image="/images/ants-spiders-hero.png"
        eyebrow="Ant &amp; Spider Control &amp; Removal Services"
        ...
        primaryCta={{ label: "Get Instant Quote", href: "/request-quote" }}
      ...
      <section id="happening" className="bk-section bk-section-dark">
        <div className="bk-container bk-narrow">
          ...
          <div className="bk-issue-content" key={activeHappening}>
            ...
            <Link to="/request-quote" className="bk-btn bk-btn-primary" style={{ marginTop: 28, display: "inline-block" }}>
        ...
        <div className="bk-container">
          <div className="bk-attract-layout">
            ...
            <div className="bk-attract-main">
              <p className="bk-eyebrow">Why Ants Choose Your Property</p>
              <h2 className="bk-h2">Why Your Property Attracts Ants</h2>
              <p className="bk-attract-intro">
                Effective ant control starts with understanding why ants chose your property in the first place. Ants aren't looking for your home, they're looking for the food, moisture, shelter, and entry points that make it easy to stay. Here's what attracts them.
              </p>
      ...
      <section id="protects" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <p className="bk-body-lead bk-center">Every home has a different story. We take the time to understand yours, solve the problem at its source, and help protect what matters most.</p>
      ...
      <section id="prevention" className="bk-section bk-section-cream">
        <div className="bk-container bk-narrow">
          ...
          <h2 className="bk-h2">Keep Ants From Coming Back</h2>
          <p className="bk-body-lead">Professional ant control doesn't end when we leave. These simple habits can help reduce future ant activity and keep your home protected between visits.</p>
