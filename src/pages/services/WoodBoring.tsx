...
const FAMILIAR_ITEMS = [
  ...
  { emoji: "🌲", icon: "/images/icon-wba-sawdust.png",         text: "I found sawdust but don't know where it came from." },
  { emoji: "🏠", icon: "/images/icon-wba-hollow-sound.png",   text: "Something is damaging the trim." },
  { emoji: "🔍", icon: "/images/icon-wba-identify.png",        text: "I'm not sure if it's termites or something else." },
  { emoji: "😟", icon: "/images/icon-wba-tapping-walls.png",  text: "I don't want hidden damage spreading." },
  { emoji: "🛠️", icon: "/images/icon-wba-stop-damage.png",    text: "I'd rather fix the problem now than replace wood later." },
];

const HAPPENING_CARDS = [
  {
    tag: "The Identification",
    title: "Not Every Hole Means Termites",
    body: "Several wood destroying insects leave similar signs but require different treatments.",
    cta: "Know the Price. Book in Minutes.",
  },
  {
    tag: "The Damage",
    title: "The Damage Builds Slowly",
    body: "Small holes and fine dust often become larger structural concerns over time.",
    cta: "Ready to Get BuzzKilled?",
  },
  {
    tag: "The Treatment",
    title: "Correct Identification Matters",
    body: "Knowing exactly which insect is causing the damage leads to the right treatment.",
    cta: "Let's Get Your Property BuzzKilled",
  },
];

const ATTRACT_REASONS = [
  { num: "01", label: "Moisture Damaged Wood",  title: "Damp Materials Attract Activity",              body: "Wood softened by moisture is easier for boring insects to penetrate and more attractive for egg laying." },
  { num: "02", label: "Exposed Lumber",         title: "Unprotected Wood Is More Vulnerable",          body: "Unfinished, untreated, or weathered wood surfaces are more susceptible to wood boring insect activity." },
  { num: "03", label: "Aging Structures",       title: "Older Wood Provides Opportunities",            body: "Older homes often have areas of untreated or deteriorating wood that make ideal targets for boring insects." },
  { num: "04", label: "Outdoor Wood",           title: "Decks And Fences Often Become Targets",        body: "Exterior wood structures exposed to weather are among the most common places wood boring activity is first noticed." },
  { num: "05", label: "Misidentified Damage",   title: "Different Insects Require Different Solutions", body: "Without correct identification, treatment may target the wrong pest and fail to stop the damage." },
];
...
const PROTECT_STEPS = [
  {
    method: "UNDERSTAND",
    num: "01",
    title: "Every sign has a cause.",
    body: "We inspect damaged wood to identify the insect responsible before recommending treatment.",
  },
  {
    method: "SOLVE",
    num: "02",
    title: "The right treatment starts here.",
    body: "Solutions are tailored to the specific wood-destroying insect affecting your property.",
  },
  {
    method: "PROTECT",
    num: "03",
    title: "Built to protect your home.",
    body: "Early action helps reduce additional damage and preserve your property's structure.",
  },
];
...
const TIPS = [
  { title: "Keep Wood Dry",                body: "Moisture attracts many wood boring insects." },
  { title: "Repair Damaged Wood",          body: "Replace weakened or rotting materials." },
  { title: "Store Lumber Correctly",       body: "Keep unused wood dry and elevated." },
  { title: "Schedule Routine Inspections", body: "Early identification helps protect your property." },
  { title: "Act Early",                    body: "Small signs are easier to address than extensive damage." },
];
...
const FAQS = [
  {
    q: "What insects damage wood?",
    a: "Several insects can damage wood including carpenter ants, powderpost beetles, and termites.",
  },
  {
    q: "How do I know which insect I have?",
    a: "A professional inspection identifies the pest before treatment begins.",
  },
  {
    q: "Can damaged wood be saved?",
    a: "That depends on the level of damage and the insect involved.",
  },
  {
    q: "Is treatment different for each insect?",
    a: "Yes. Effective treatment depends on correctly identifying the pest.",
  },
  {
    q: "How quickly should I act?",
    a: "Early treatment helps reduce additional structural damage.",
  },
  {
    q: "Can I request an inspection online?",
    a: "Yes. Use the Instant Quote tool to schedule your visit.",
  },
];
...
export default function WoodBoring() {
  ...
  return (
    <>
      ...
      {/* 1. Hero */}
      <Hero
        image="/images/wood-boring-hero.png"
        eyebrow="Wood Boring Insect Control Services"
        ...
        <div className="bk-container">
          <div className="bk-attract-layout">
            ...
            <div className="bk-attract-main">
              ...
              <h2 className="bk-h2">Why Wood Destroying Insects Appear</h2>
              <p className="bk-attract-intro">
                Wood boring insects follow conditions, not chance. Identifying what makes your home's wood vulnerable is the key to lasting protection.
              </p>
      ...
      <section id="protects" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <p className="bk-body-lead bk-center">Not every hole in wood tells the same story. Identifying the insect correctly is the first step toward protecting your home's structure.</p>
      ...
      <section id="prevention" className="bk-section bk-section-cream">
        <div className="bk-container bk-narrow">
          ...
          <h2 className="bk-h2">Help Protect Your Wood Structures</h2>
          <p className="bk-body-lead">Simple maintenance helps reduce the risk of wood destroying insects.</p>
