 ...
 * environment-dependent (prod vs staging) and has no custom domain yet, so it
 * is overridable per build via VITE_PORTAL_URL and falls back to the production
 * CRM app. Signing in at the root lands a customer on /portal via HomeRedirect.
 *
