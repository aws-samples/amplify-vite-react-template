...
const FAMILIAR_ITEMS = [
  ...
  { emoji: "🏠", icon: "/images/icon-attic-living-in.png",    text: "Something is definitely living in my attic." },
  { emoji: "😬", icon: "/images/icon-attic-noises-louder.png",text: "The noises seem louder every night." },
  { emoji: "🐭", icon: "/images/icon-attic-nesting.png",      text: "I'm worried they've started nesting." },
  { emoji: "😷", icon: "/images/icon-attic-smells.png",       text: "The attic smells different lately." },
  { emoji: "🤦", icon: "/images/icon-attic-ignoring.png",     text: "Ignoring it isn't making it go away." },
];

const HAPPENING_CARDS = [
  {
    tag: "The Shelter",
    title: "Attics Feel Safe To Rodents",
    body: "Warmth, insulation, and little human activity make attics ideal nesting areas.",
    cta: "Know the Price. Book in Minutes.",
  },
  {
    tag: "The Population",
    title: "One Rodent Usually Means More",
    body: "Rodents reproduce quickly once they establish shelter.",
    cta: "Ready to Get BuzzKilled?",
  },
  {
    tag: "The Solution",
    title: "Removing Them Doesn't Solve Everything",
    body: "Cleaning and sealing the attic helps prevent future infestations.",
    cta: "Let's Get Your Property BuzzKilled",
  },
];

const ATTRACT_REASONS = [
  { num: "01", label: "Warmth",              title: "Attics Stay Comfortable Year Round",       body: "Attic insulation keeps temperatures stable, making the space comfortable for rodents regardless of outdoor weather." },
  { num: "02", label: "Insulation",          title: "Perfect Material For Nest Building",       body: "Fiberglass and cellulose insulation provide ideal nesting material that rodents pull apart and reshape." },
  { num: "03", label: "Limited Disturbance", title: "Quiet Spaces Feel Safe",                   body: "Attics are rarely visited, giving rodents time to establish nesting areas without interruption." },
  { num: "04", label: "Roof Entry",          title: "Small Openings Lead Inside",               body: "Gaps at roof vents, soffits, and where the roof meets the fascia are common access points." },
  { num: "05", label: "Nearby Trees",        title: "Branches Create Easy Roof Access",         body: "Overhanging tree branches act as natural bridges from the ground to your roofline." },
];
...
const PROTECT_STEPS = [
  {
    method: "UNDERSTAND",
    num: "01",
    title: "We uncover what's happening above.",
    body: "We inspect attic spaces for nesting, activity, and the entry points rodents are using.",
  },
  {
    method: "SOLVE",
    num: "02",
    title: "We remove the activity.",
    body: "Targeted rodent control focuses on the areas where rodents live, travel, and nest.",
  },
  {
    method: "PROTECT",
    num: "03",
    title: "A quieter attic starts here.",
    body: "Helping reduce future rodent activity means protecting the spaces they rely on most.",
  },
];
...
const TIPS = [
  { title: "Inspect Roof Openings",        body: "Check vents, soffits, and rooflines regularly." },
  { title: "Trim Tree Branches",           body: "Reduce easy access to your roof." },
  { title: "Store Items Properly",         body: "Keep attic storage organized and off insulation where possible." },
  { title: "Watch for Activity",           body: "Strange sounds or droppings should never be ignored." },
  { title: "Schedule Preventative Inspections", body: "Routine inspections help prevent new infestations." },
];
...
const FAQS = [
  {
    q: "How do rodents get into attics?",
    a: "They often enter through roof gaps, vents, or damaged exterior openings.",
  },
  {
    q: "What are signs of attic activity?",
    a: "Scratching sounds, droppings, nesting materials, and damaged insulation.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Rodents frequently contaminate and damage attic insulation.",
  },
  {
    q: "Can rodents return?",
    a: "Without addressing entry points they can. We help identify how they entered.",
  },
  {
    q: "Can I schedule online?",
    a: "Yes. Get an Instant Quote and choose a convenient appointment.",
  },
];
...
export default function RodentAttic() {
  ...
  return (
    <>
      ...
      {/* 1. Hero */}
      <Hero
        image="/images/attic-rodent-hero.png"
        eyebrow="Attic Rodent Control Services"
      ...
      <section id="happening" className="bk-section bk-section-dark">
        <div className="bk-container bk-narrow">
          ...
          <p className="bk-issue-intro">Rodent activity in the attic rarely stays in the attic. Understanding how they got in and what's keeping them there is the first step toward lasting control, not just temporary relief.</p>
      ...
      {/* 4. Why Rodents Choose Your Attic */}
        ...
        <div className="bk-container">
          <div className="bk-attract-layout">
            ...
            <div className="bk-attract-main">
              ...
              <h2 className="bk-h2">Why Rodents Choose Your Attic</h2>
              <p className="bk-attract-intro">
                Attics provide exactly what rodents are looking for. Understanding why they choose this space helps us remove them and protect against future activity.
              </p>
      ...
      <section id="protects" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <p className="bk-body-lead bk-center">Your attic should protect your home, not become a home for rodents. We locate the activity, remove it, and help prevent it from returning.</p>
      ...
      <section id="prevention" className="bk-section bk-section-cream">
        <div className="bk-container bk-narrow">
          ...
          <h2 className="bk-h2">Protect Your Attic</h2>
          <p className="bk-body-lead">Keeping rodents out starts with reducing the conditions they depend on.</p>
      ...
      <section id="related" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <h2 className="bk-h2 bk-center">Your Pest Problem Might Not Stop in the Attic</h2>
          <p className="bk-body-lead bk-center">Attic rodents are often just the beginning. Explore the other pest control services BuzzKill provides across Massachusetts &amp; Rhode Island.</p>
