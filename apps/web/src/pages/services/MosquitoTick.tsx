...
const FAMILIAR_ITEMS = [
  ...
  { emoji: "🍔", icon: "/images/icon-mosquito-dinners.png",   text: "Backyard dinners don't last very long anymore." },
  { emoji: "🌅", icon: "/images/icon-mosquito-evenings.png",  text: "Evenings belong to mosquitoes now." },
  { emoji: "🐶", icon: "/images/icon-mosquito-dog-bites.png", text: "My dog comes inside covered in bites." },
  { emoji: "😩", icon: "/images/icon-mosquito-citronella.png", text: "Citronella isn't cutting it anymore." },
  { emoji: "🌳", icon: "/images/icon-mosquito-yard-back.png", text: "I want my yard back." },
];

const HAPPENING_CARDS = [
  {
    tag: "The Breeding Ground",
    title: "Mosquitoes Breed Close To Home",
    body: "Standing water only a few feet away can support hundreds of mosquitoes.",
    cta: "Know the Price. Book in Minutes.",
  },
  {
    tag: "The Hiding Place",
    title: "Shade Is Their Favorite Hiding Place",
    body: "Mosquitoes spend much of the day resting in shrubs, landscaping, and dense vegetation.",
    cta: "Ready to Get BuzzKilled?",
  },
  {
    tag: "The Treatment",
    title: "Treating The Yard Interrupts Their Cycle",
    body: "Targeting resting and breeding areas helps reduce mosquito activity where you spend time.",
    cta: "Let's Get Your Property BuzzKilled",
  },
];

const ATTRACT_REASONS = [
  { num: "01", label: "Standing Water",       title: "Small Amounts Create Big Problems",          body: "Just a small amount of standing water is enough for mosquitoes to lay eggs and begin a new cycle." },
  { num: "02", label: "Dense Landscaping",    title: "Shade Gives Mosquitoes A Place To Rest",    body: "Overgrown shrubs, low tree branches, and thick ground cover keep mosquitoes cool during the hottest parts of the day." },
  { num: "03", label: "Humid Conditions",     title: "Warm Weather Speeds Activity",               body: "Heat and humidity accelerate the mosquito life cycle, leading to faster population growth through summer." },
  { num: "04", label: "Poor Drainage",        title: "Wet Areas Become Breeding Sites",            body: "Low spots in the yard, clogged gutters, and slow draining areas hold the moisture mosquitoes need." },
  { num: "05", label: "Seasonal Growth",      title: "Populations Increase Quickly",               body: "Mosquito populations peak in late spring and summer, making early seasonal treatment more effective than waiting." },
];
...
const PROTECT_STEPS = [
  {
    method: "UNDERSTAND",
    num: "01",
    title: "We know where mosquitoes hide.",
    body: "We inspect standing water, shaded landscaping, and other areas that support mosquito activity.",
  },
  {
    method: "SOLVE",
    num: "02",
    title: "We target the source.",
    body: "Treatments focus on where mosquitoes rest and breed throughout your property.",
  },
  {
    method: "PROTECT",
    num: "03",
    title: "More time outside.",
    body: "Seasonal mosquito control helps keep your yard ready for family and friends.",
  },
];
...
const TIPS = [
  { title: "Remove Standing Water",        body: "Empty containers, bird baths, and clogged gutters regularly." },
  { title: "Trim Dense Vegetation",        body: "Mosquitoes prefer cool shaded areas." },
  { title: "Maintain Your Lawn",           body: "Regular mowing helps reduce resting areas." },
  { title: "Refresh Water Features",       body: "Keep decorative water moving whenever possible." },
  { title: "Continue Seasonal Treatments", body: "Routine applications provide the best protection." },
];
...
const FAQS = [
  {
    ...
    a: "Seasonal treatments provide the most consistent mosquito protection.",
  },
  {
    q: "Will treatment affect my landscaping?",
    a: "Treatments are applied carefully around your outdoor spaces.",
  },
  {
    q: "Can mosquitoes return?",
    a: "New mosquitoes can enter from nearby areas throughout the season.",
  },
  {
    q: "Is treatment safe for pets?",
    a: "Yes. Your technician will explain any precautions before treatment.",
  },
  {
    q: "Will treatment eliminate every mosquito?",
    a: "No treatment can prevent every mosquito, but it can greatly reduce activity.",
  },
  {
    q: "Can I book online?",
    a: "Yes. Use our Instant Quote tool to schedule service.",
  },
];
...
export default function MosquitoTick() {
  ...
  return (
    <>
      <SEO
        title="Mosquito & Tick Control Services — MA & RI"
        description="Professional mosquito and tick control for Massachusetts and Rhode Island yards. Our seasonal program reduces activity so you can enjoy your outdoor spaces. Get an instant quote."
        jsonLd={[
          buildServiceSchema(
            "Mosquito & Tick Control Services",
            "Professional seasonal mosquito and tick control for Massachusetts and Rhode Island properties, reducing activity to protect families, pets, and outdoor spaces.",
            "/services/mosquito-tick",
          ),
          buildBreadcrumbSchema([
            { name: "Home", url: "/" },
            { name: "Services", url: "/services/mosquito-tick" },
      ...
      {/* 1. Hero */}
      <Hero
        image="/images/mosquito-hero.png"
        eyebrow="Mosquito Control Services"
      ...
      <section id="happening" className="bk-section bk-section-dark">
        <div className="bk-container bk-narrow">
          ...
          <p className="bk-issue-intro">Most mosquito and tick problems come from where they breed and wait. Understanding what draws them to your yard is the first step toward reducing their activity all season, not just temporary relief.</p>
      ...
      {/* 4. Why Mosquitoes Love Your Yard */}
        ...
        <div className="bk-container">
          <div className="bk-attract-layout">
            ...
            <div className="bk-attract-main">
              ...
              <h2 className="bk-h2">Why Mosquitoes Love Your Yard</h2>
              <p className="bk-attract-intro">
                Mosquitoes breed and rest in specific conditions around your property. Identifying those conditions is the first step toward reducing their impact on your outdoor spaces.
              </p>
      ...
      <section id="protects" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <p className="bk-body-lead bk-center">Your yard should be a place to relax, not a place mosquitoes take over. We identify breeding areas, reduce activity, and help you enjoy your outdoor spaces again.</p>
      ...
      <section id="prevention" className="bk-section bk-section-cream">
        <div className="bk-container bk-narrow">
          ...
          <h2 className="bk-h2">Keep Mosquitoes Away</h2>
          <p className="bk-body-lead">Small changes around your yard can help reduce mosquito breeding throughout the season.</p>
      ...
      <section id="related" className="bk-section bk-section-cream">
        <div className="bk-container">
          ...
          <h2 className="bk-h2 bk-center">Your Pest Problem Might Not Stop at Mosquitoes &amp; Ticks</h2>
          <p className="bk-body-lead bk-center">Mosquitoes and ticks are often just the beginning. Explore the other pest control services BuzzKill provides across Massachusetts &amp; Rhode Island.</p>
