    ...
    const result = await createLead(
      {
        ...
        contactConsentText:
          ...
          "Customer supplied these contact details in a direct service inquiry and requested a response.",
        contactConsentPolicyVersion: "website-lead-consent-2026-07-19",
      },
      { sub: null, email: null }
    );
